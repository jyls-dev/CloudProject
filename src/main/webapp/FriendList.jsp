...
<body>
	...
	<!-- End of container -->
		...
		<div class="jumbotron">
		  <div class="container">
		  <h1 class="display-6">Mes followings</h1><br>
			<h2 class="display-5">Les personnes que je suis.</h2>
	    		...
	    		<div class="card">
					<div class="card-body">
						<div>
							<table>
								<tr>
									<td style="text-align:middle"><div style="width:500px; "><h4>${item} </h4></div></td>
									<td style="text-align:middle"> <a href="/delFriend/ + ${item}"  class="btn btn-primary">Unfollow</a></td>
								</tr>
								<tr>
									<hr>
								</tr>

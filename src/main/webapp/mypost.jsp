...
<header>
	...
	<div class="container">
		...
		<a href="view"><button class="input-group-text btn-success btn-lg">Revenir à la TimeLine</button></a>  
		<a href="/prefixcleanuser"><button class="input-group-text btn-primary btn-lg">Supprimer tous les Posts</button></a>
		</div>
...
<main>
	...
	<div class="container">
		...
		<div class="gallery-item" tabindex="0">
				...
				<img src=<%=infos.getPostUrl(valeur) %> class="gallery-image" alt="">
				...
				<div class="gallery-item-info">
					...
					<ul>
						<li class="gallery-item-likes"><span class="visually-hidden">Likes:</span><i class="fas fa-heart" aria-hidden="true"></i> <%=infos.getNbLike(valeur) %></li>
					</ul>

				</div>
				
				<div class="card">
					<p> <b><%=infos.getBody(valeur) %></b> </p>
				</div>
				
				<div class="card">
				<a href="/prefixcleanpost/${item}"><button  class="btn-danger btn-sm"> <b>Supprimer</b> </button></a>
				</div>
